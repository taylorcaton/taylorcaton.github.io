  ...
  <section class="container" :class="{ rock: this.isAnimated }">
    <div class="heading-container">
      <h1 class="title is-spaced">
        <span
          :class="{ wave: this.isAnimated }"
          @mouseover="$emit('hyperSpeed', 0.8)"
          @focus="$emit('hyperSpeed', 0.4)"
          @mouseleave="$emit('hyperSpeed', 0.1)"
      ...
      <a
        href="https://github.com/taylorcaton"
        target="_blank"
        @mouseover="$emit('hyperSpeed', 0.4)"
        @focus="$emit('hyperSpeed', 0.4)"
        @mouseleave="$emit('hyperSpeed', 0.1)"
        @blur="$emit('hyperSpeed', 0.1)"
      >
      ...
      <a
        href="https://www.linkedin.com/in/taylorcaton/"
        target="_blank"
        @mouseover="$emit('hyperSpeed', 0.4)"
        @focus="$emit('hyperSpeed', 0.4)"
        @mouseleave="$emit('hyperSpeed', 0.1)"
